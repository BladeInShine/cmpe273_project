	...
	sql_con.fetchData(pquery, function(errors, rows){
		for(var i=0;i<rows.length;i++){
			...
			if(rows[i].sellorauction=="sell"){
				ret+='<li id="item4ae0b9474b" _sp="p2045573.m1686.l3080" listingId="321597818699" class="sresult lvresult clearfix li" r="1" ><div class="lvpic pic p225 img left" iid="321597818699"><div class="lvpicinner full-width picW s225"><img height="225" width="225" src="'+rows[i].pictureurl+'" class="img"/></div></div><h3 class="lvtitle"><a href="http://www.ebay.com/itm/Brand-New-Factory-Sealed-Psv-Ps-Vita-Ultimate-Marvel-VS-Capcom-3-Region-Free-/321597818699?pt=Video_Games_Games&hash=item4ae0b9474b" class="vip">'+rows[i].name+'</a></h3><ul class="lvprices left space-zero"><li class="lvprice prc"><span  class="g-b">$'+rows[i].price.toFixed(2)+'</span></li><li class="lvextras"><div class="hotness bold"></div></li></ul></li>';

			}
			else{
				ret+='<li id="item4ae0b9474b" _sp="p2045573.m1686.l3080" listingId="321597818699" class="sresult lvresult clearfix li" r="1" ><div class="lvpic pic p225 img left" iid="321597818699"><div class="lvpicinner full-width picW s225"><img height="225" width="225" src="'+rows[i].pictureurl+'" class="img"/></div></div><h3 class="lvtitle"><a href="http://www.ebay.com/itm/Brand-New-Factory-Sealed-Psv-Ps-Vita-Ultimate-Marvel-VS-Capcom-3-Region-Free-/321597818699?pt=Video_Games_Games&hash=item4ae0b9474b" class="vip">'+rows[i].name+'</a></h3><ul class="lvprices left space-zero"><li class="lvprice prc"><span  class="g-b">$'+rows[i].currentprice.toFixed(2)+'</span></li><li class="lvextras"><div class="hotness bold"></div></li></ul></li>';
